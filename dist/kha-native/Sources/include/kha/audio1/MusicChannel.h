...
#define INCLUDED_kha_audio1_MusicChannel
...
class HXCPP_CLASS_ATTRIBUTES  MusicChannel_obj : public hx::Interface{
	public:
...
class MusicChannel_delegate_ : public MusicChannel_obj
{
	protected:
		IMPL *mDelegate;
	public:
		MusicChannel_delegate_(IMPL *inDelegate) : mDelegate(inDelegate) {}
...
#endif /* INCLUDED_kha_audio1_MusicChannel */ 
