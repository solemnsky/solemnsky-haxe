...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/StringTools.hx",36,0xa041a894)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(44)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/StringTools.hx",61,0xa041a894)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(69)
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_FRAME("StringTools","isSpace",0xe0290778,"StringTools.isSpace","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/StringTools.hx",183,0xa041a894)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_FRAME("StringTools","ltrim",0x24d2234a,"StringTools.ltrim","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/StringTools.hx",200,0xa041a894)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(204)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_FRAME("StringTools","rtrim",0x99399e50,"StringTools.rtrim","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/StringTools.hx",225,0xa041a894)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(229)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(230)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_FRAME("StringTools","trim",0x2908d066,"StringTools.trim","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/StringTools.hx",247,0xa041a894)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(253)
...
::String StringTools_obj::hex( int n,Dynamic digits){
	HX_STACK_FRAME("StringTools","hex",0xd91debd7,"StringTools.hex","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/StringTools.hx",334,0xa041a894)
	HX_STACK_ARG(n,"n")
