...
::zpp_nape::geom::ZPP_PartitionedPoly ZNPNode_ZPP_PartitionedPoly_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_PartitionedPoly","elem",0xbcf39d79,"zpp_nape.util.ZNPNode_ZPP_PartitionedPoly.elem","zpp_nape/util/Lists.hx",15497,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15498)
