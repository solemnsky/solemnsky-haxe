...
Void ZNPArray2_ZPP_MarchPair_obj::resize( int width,int height,::zpp_nape::geom::ZPP_MarchPair def){
{
		...
		HX_STACK_LINE(323)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(324)
				::zpp_nape::geom::ZPP_MarchPair tmp6 = def;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(324)
				tmp4[tmp5] = tmp6;
			}
		}
...
::zpp_nape::geom::ZPP_MarchPair ZNPArray2_ZPP_MarchPair_obj::get( int x,int y){
	...
	HX_STACK_LINE(338)
	::zpp_nape::geom::ZPP_MarchPair tmp6 = tmp->__get(tmp5).StaticCast< ::zpp_nape::geom::ZPP_MarchPair >();		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(338)
	return tmp6;
}
...
::zpp_nape::geom::ZPP_MarchPair ZNPArray2_ZPP_MarchPair_obj::set( int x,int y,::zpp_nape::geom::ZPP_MarchPair obj){
	...
	int tmp5 = (tmp3 + tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(351)
	::zpp_nape::geom::ZPP_MarchPair tmp6 = obj;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(351)
	::zpp_nape::geom::ZPP_MarchPair tmp7 = tmp[tmp5] = tmp6;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(351)
	return tmp7;
}
...
bool ZNPArray2_ZPP_MarchPair_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ZNPArray2_ZPP_MarchPair_obj::__register()
{
	...
	__mClass->mSetStaticField = &ZNPArray2_ZPP_MarchPair_obj::__SetStatic;
