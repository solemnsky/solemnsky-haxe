...
{  hx::ObjectPtr< ZNPNode_ZPP_CallbackSet_obj > _result_ = new ZNPNode_ZPP_CallbackSet_obj();
...
::zpp_nape::space::ZPP_CallbackSet ZNPNode_ZPP_CallbackSet_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_CallbackSet","elem",0xe1aaf8d1,"zpp_nape.util.ZNPNode_ZPP_CallbackSet.elem","zpp_nape/util/Lists.hx",14852,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14853)
	::zpp_nape::space::ZPP_CallbackSet tmp = this->elt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(14853)
	return tmp;
}
...
Dynamic ZNPNode_ZPP_CallbackSet_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZNPNode_ZPP_CallbackSet_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
