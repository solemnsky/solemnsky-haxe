...
{  hx::ObjectPtr< ZNPNode_ZPP_SimpleVert_obj > _result_ = new ZNPNode_ZPP_SimpleVert_obj();
...
::zpp_nape::geom::ZPP_SimpleVert ZNPNode_ZPP_SimpleVert_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_SimpleVert","elem",0x52642ee9,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.elem","zpp_nape/util/Lists.hx",15626,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15627)
	::zpp_nape::geom::ZPP_SimpleVert tmp = this->elt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(15627)
	return tmp;
}
...
Dynamic ZNPNode_ZPP_SimpleVert_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZNPNode_ZPP_SimpleVert_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
