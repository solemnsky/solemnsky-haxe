...
{  hx::ObjectPtr< ZNPNode_ZPP_Shape_obj > _result_ = new ZNPNode_ZPP_Shape_obj();
...
::zpp_nape::shape::ZPP_Shape ZNPNode_ZPP_Shape_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Shape","elem",0xedcfef4d,"zpp_nape.util.ZNPNode_ZPP_Shape.elem","zpp_nape/util/Lists.hx",14895,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14896)
	::zpp_nape::shape::ZPP_Shape tmp = this->elt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(14896)
	return tmp;
}
...
Dynamic ZNPNode_ZPP_Shape_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZNPNode_ZPP_Shape_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
