...
{  hx::ObjectPtr< ZNPNode_ZPP_GeomPoly_obj > _result_ = new ZNPNode_ZPP_GeomPoly_obj();
...
::zpp_nape::geom::ZPP_GeomPoly ZNPNode_ZPP_GeomPoly_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_GeomPoly","elem",0x293525e4,"zpp_nape.util.ZNPNode_ZPP_GeomPoly.elem","zpp_nape/util/Lists.hx",16228,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16229)
	::zpp_nape::geom::ZPP_GeomPoly tmp = this->elt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(16229)
	return tmp;
}
...
Dynamic ZNPNode_ZPP_GeomPoly_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZNPNode_ZPP_GeomPoly_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_GeomPoly*/ ,(int)offsetof(ZNPNode_ZPP_GeomPoly_obj,next),HX_HCSTRING("next","\xf3","\x84","\x02","\x49")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_GeomPoly*/ ,(int)offsetof(ZNPNode_ZPP_GeomPoly_obj,elt),HX_HCSTRING("elt","\x2d","\x02","\x4d","\x00")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_GeomPoly*/ ,(void *) &ZNPNode_ZPP_GeomPoly_obj::zpp_pool,HX_HCSTRING("zpp_pool","\x81","\x5d","\xd4","\x38")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void ZNPNode_ZPP_GeomPoly_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("zpp_nape.util.ZNPNode_ZPP_GeomPoly","\x39","\x13","\xe1","\x58");
