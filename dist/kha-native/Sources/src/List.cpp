...
{
HX_STACK_FRAME("List","new",0xed890070,"List.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/List.hx",41,0x122bba00)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
...
{
		HX_STACK_FRAME("List","add",0xed7f2231,"List.add","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/List.hx",49,0x122bba00)
		HX_STACK_THIS(this)
...
::_List::ListIterator List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/List.hx",161,0x122bba00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(162)
