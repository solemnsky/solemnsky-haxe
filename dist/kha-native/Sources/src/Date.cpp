...
{
HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/Date.hx",26,0xb5239d31)
HX_STACK_THIS(this)
...
Float Date_obj::getTime( ){
	HX_STACK_FRAME("Date","getTime",0x0cac7da3,"Date.getTime","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/Date.hx",30,0xb5239d31)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
::Date Date_obj::fromTime( Float t){
	HX_STACK_FRAME("Date","fromTime",0x44fd3cb7,"Date.fromTime","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/Date.hx",57,0xb5239d31)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(58)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/Date.hx",64,0xb5239d31)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(64)
