...
{
HX_STACK_FRAME("_List.ListIterator","new",0x1ee472af,"_List.ListIterator.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/List.hx",244,0x122bba00)
HX_STACK_THIS(this)
...
bool ListIterator_obj::hasNext( ){
	HX_STACK_FRAME("_List.ListIterator","hasNext",0x25781b3c,"_List.ListIterator.hasNext","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/List.hx",249,0x122bba00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(250)
...
Dynamic ListIterator_obj::next( ){
	HX_STACK_FRAME("_List.ListIterator","next",0xe8ffe7c4,"_List.ListIterator.next","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/List.hx",253,0x122bba00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(254)
	cpp::ArrayBase tmp = this->head;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(254)
