...
{
HX_STACK_FRAME("haxe.ds.EnumValueMap","new",0x9ce29655,"haxe.ds.EnumValueMap.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/EnumValueMap.hx",31,0x64f9651b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(31)
	super::__construct();
...
int EnumValueMap_obj::compare( Dynamic _tmp_k1,Dynamic _tmp_k2){
	HX_STACK_FRAME("haxe.ds.EnumValueMap","compare",0x806a7d1a,"haxe.ds.EnumValueMap.compare","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/EnumValueMap.hx",33,0x64f9651b)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(36)
	cpp::ArrayBase tmp5 = ::Type_obj::enumParameters(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(36)
	cpp::ArrayBase p1 = tmp5;		HX_STACK_VAR(p1,"p1");
	HX_STACK_LINE(37)
	Dynamic tmp6 = k2;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(37)
	cpp::ArrayBase tmp7 = ::Type_obj::enumParameters(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(37)
	cpp::ArrayBase p2 = tmp7;		HX_STACK_VAR(p2,"p2");
	HX_STACK_LINE(38)
	bool tmp8 = (p1->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ) == (int)0);		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(38)
	bool tmp9;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(38)
	if ((tmp8)){
		HX_STACK_LINE(38)
		tmp9 = (p2->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ) == (int)0);
	}
	else{
		HX_STACK_LINE(38)
		tmp9 = false;
	...
	HX_STACK_LINE(39)
	cpp::ArrayBase tmp10 = p1;		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(39)
	cpp::ArrayBase tmp11 = p2;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(39)
	int tmp12 = this->compareArgs(tmp10,tmp11);		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(39)
	return tmp12;
}
...
int EnumValueMap_obj::compareArgs( cpp::ArrayBase a1,cpp::ArrayBase a2){
	HX_STACK_FRAME("haxe.ds.EnumValueMap","compareArgs",0x37a5cb97,"haxe.ds.EnumValueMap.compareArgs","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/EnumValueMap.hx",42,0x64f9651b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a1,"a1")
	HX_STACK_ARG(a2,"a2")
	HX_STACK_LINE(43)
...
int EnumValueMap_obj::compareArg( Dynamic v1,Dynamic v2){
	HX_STACK_FRAME("haxe.ds.EnumValueMap","compareArg",0xcee2e55c,"haxe.ds.EnumValueMap.compareArg","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/EnumValueMap.hx",52,0x64f9651b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v1,"v1")
	HX_STACK_ARG(v2,"v2")
	HX_STACK_LINE(53)
