...
{
HX_STACK_FRAME("haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",220,0x8d93b7e1)
HX_STACK_THIS(this)
HX_STACK_ARG(l,"l")
HX_STACK_ARG(k,"k")
HX_STACK_ARG(v,"v")
...
bool TreeNode_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void TreeNode_obj::__register()
{
	...
	__mClass->mSetStaticField = &TreeNode_obj::__SetStatic;
