...
{
HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",52,0x9f4447d7)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",55,0x9f4447d7)
		HX_STACK_THIS(this)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",58,0x9f4447d7)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(59)
...
Dynamic ObjectMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",70,0x9f4447d7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
	cpp::ArrayBase tmp = ::__object_hash_keys(this->h);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(71)
