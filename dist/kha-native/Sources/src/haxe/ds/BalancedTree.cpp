...
{
HX_STACK_FRAME("haxe.ds.BalancedTree","new",0xfb50b0cf,"haxe.ds.BalancedTree.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",41,0x8d93b7e1)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.BalancedTree","set",0xfb547c11,"haxe.ds.BalancedTree.set","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",50,0x8d93b7e1)
		HX_STACK_THIS(this)
...
Dynamic BalancedTree_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.BalancedTree","get",0xfb4b6105,"haxe.ds.BalancedTree.get","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",61,0x8d93b7e1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(62)
...
Dynamic BalancedTree_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.BalancedTree","keys",0xe94e62a5,"haxe.ds.BalancedTree.keys","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",126,0x8d93b7e1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(127)
	cpp::ArrayBase tmp = cpp::ArrayBase_obj::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(127)
	cpp::ArrayBase ret = tmp;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(128)
	::haxe::ds::TreeNode tmp1 = this->root;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(128)
	cpp::ArrayBase tmp2 = ret;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(128)
	this->keysLoop(tmp1,tmp2);
	HX_STACK_LINE(129)
	Dynamic tmp3 = ret->__Field(HX_HCSTRING("iterator","\xee","\x49","\x9a","\x93"), hx::paccDynamic )();		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(129)
	return tmp3;
}
...
::haxe::ds::TreeNode BalancedTree_obj::setLoop( Dynamic k,Dynamic v,::haxe::ds::TreeNode node){
	HX_STACK_FRAME("haxe.ds.BalancedTree","setLoop",0xe1a32b15,"haxe.ds.BalancedTree.setLoop","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",132,0x8d93b7e1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(k,"k")
	HX_STACK_ARG(v,"v")
...
Void BalancedTree_obj::keysLoop( ::haxe::ds::TreeNode node,cpp::ArrayBase acc){
{
		HX_STACK_FRAME("haxe.ds.BalancedTree","keysLoop",0x20d5eba9,"haxe.ds.BalancedTree.keysLoop","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",161,0x8d93b7e1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(node,"node")
		...
		if ((tmp)){
			HX_STACK_LINE(163)
			::haxe::ds::TreeNode tmp1 = node->left;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(163)
			cpp::ArrayBase tmp2 = acc;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(163)
			this->keysLoop(tmp1,tmp2);
			HX_STACK_LINE(164)
			Dynamic tmp3 = node->key;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(164)
			acc->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp3);
			HX_STACK_LINE(165)
			::haxe::ds::TreeNode tmp4 = node->right;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(165)
			cpp::ArrayBase tmp5 = acc;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(165)
			this->keysLoop(tmp4,tmp5);
		}
	}
return null();
}
...
::haxe::ds::TreeNode BalancedTree_obj::balance( ::haxe::ds::TreeNode l,Dynamic k,Dynamic v,::haxe::ds::TreeNode r){
	HX_STACK_FRAME("haxe.ds.BalancedTree","balance",0xf7f4e10b,"haxe.ds.BalancedTree.balance","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",187,0x8d93b7e1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(l,"l")
	HX_STACK_ARG(k,"k")
	HX_STACK_ARG(v,"v")
...
int BalancedTree_obj::compare( Dynamic k1,Dynamic k2){
	HX_STACK_FRAME("haxe.ds.BalancedTree","compare",0x57d05c94,"haxe.ds.BalancedTree.compare","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",201,0x8d93b7e1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(k1,"k1")
	HX_STACK_ARG(k2,"k2")
	HX_STACK_LINE(202)
