...
{
HX_STACK_FRAME("haxe.Serializer","new",0xcdbbc7ec,"haxe.Serializer.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/Serializer.hx",100,0x83b02f63)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(101)
	...
	this->cache = tmp1;
	HX_STACK_LINE(103)
	bool tmp2 = ::haxe::Serializer_obj::USE_CACHE;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(103)
	this->useCache = tmp2;
	HX_STACK_LINE(104)
	bool tmp3 = ::haxe::Serializer_obj::USE_ENUM_INDEX;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(104)
	this->useEnumIndex = tmp3;
	HX_STACK_LINE(105)
...
::String Serializer_obj::toString( ){
	HX_STACK_FRAME("haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/Serializer.hx",115,0x83b02f63)
	HX_STACK_THIS(this)
	HX_STACK_LINE(116)
...
{
		HX_STACK_FRAME("haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/Serializer.hx",152,0x83b02f63)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(153)
...
bool Serializer_obj::serializeRef( Dynamic v){
	HX_STACK_FRAME("haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/Serializer.hx",171,0x83b02f63)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(175)
	{
		...
		HX_STACK_LINE(175)
		cpp::ArrayBase tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(175)
		...
		while((true)){
			...
			HX_STACK_LINE(180)
			cpp::ArrayBase tmp4 = this->cache;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(180)
			...
			if ((tmp8)){
				...
				HX_STACK_LINE(182)
				tmp9->add(HX_HCSTRING("r","\x72","\x00","\x00","\x00"));
				HX_STACK_LINE(183)
				::StringBuf tmp10 = this->buf;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(183)
...
{
		HX_STACK_FRAME("haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/Serializer.hx",208,0x83b02f63)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(209)
		{
			...
			HX_STACK_LINE(209)
			Array< ::String > tmp1 = ::Reflect_obj::fields(tmp);		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(209)
...
{
		HX_STACK_FRAME("haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/Serializer.hx",227,0x83b02f63)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(227)
		{
				...
				case (int)6: {
					...
					HX_STACK_LINE(250)
					{
						...
						if (  ( _switch_1==hx::ClassOf< Array<int> >())){
							...
							{
								HX_STACK_LINE(293)
								cpp::ArrayBase _g1_head = v1->h;		HX_STACK_VAR(_g1_head,"_g1_head");
								HX_STACK_LINE(293)
								Dynamic _g1_val = null();		HX_STACK_VAR(_g1_val,"_g1_val");
								HX_STACK_LINE(293)
								while((true)){
									HX_STACK_LINE(293)
									bool tmp8 = (_g1_head != null());		HX_STACK_VAR(tmp8,"tmp8");
									HX_STACK_LINE(293)
									...
									{
										HX_STACK_LINE(293)
										Dynamic tmp11 = _g1_head->__GetItem((int)0);		HX_STACK_VAR(tmp11,"tmp11");
										HX_STACK_LINE(293)
										_g1_val = tmp11;
										HX_STACK_LINE(293)
										Dynamic tmp12 = _g1_head->__GetItem((int)1);		HX_STACK_VAR(tmp12,"tmp12");
										HX_STACK_LINE(293)
										_g1_head = tmp12;
										HX_STACK_LINE(226)
										tmp10 = _g1_val;
...
;
							...
							HX_STACK_LINE(340)
							::String tmp8 = ::haxe::Serializer_obj::BASE64;		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(340)
							::String b64 = tmp8;		HX_STACK_VAR(b64,"b64");
							HX_STACK_LINE(341)
							while((true)){
								HX_STACK_LINE(341)
								bool tmp9 = (i < max);		HX_STACK_VAR(tmp9,"tmp9");
								HX_STACK_LINE(341)
								bool tmp10 = !(tmp9);		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(341)
								if ((tmp10)){
								...
								HX_STACK_LINE(344)
								int b3 = tmp13;		HX_STACK_VAR(b3,"b3");
								HX_STACK_LINE(346)
								int tmp14 = (int(b1) >> int((int)2));		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(346)
								::String tmp15 = b64.charAt(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(346)
								charsBuf->add(tmp15);
								HX_STACK_LINE(347)
								int tmp16 = (int(b1) << int((int)4));		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(347)
								int tmp17 = (int(b2) >> int((int)4));		HX_STACK_VAR(tmp17,"tmp17");
								HX_STACK_LINE(347)
								int tmp18 = (int(tmp16) | int(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(347)
								int tmp19 = (int(tmp18) & int((int)63));		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(347)
								::String tmp20 = b64.charAt(tmp19);		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(347)
								charsBuf->add(tmp20);
								HX_STACK_LINE(348)
								int tmp21 = (int(b2) << int((int)2));		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(348)
								int tmp22 = (int(b3) >> int((int)6));		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(348)
								int tmp23 = (int(tmp21) | int(tmp22));		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(348)
								int tmp24 = (int(tmp23) & int((int)63));		HX_STACK_VAR(tmp24,"tmp24");
								HX_STACK_LINE(348)
								::String tmp25 = b64.charAt(tmp24);		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(348)
								charsBuf->add(tmp25);
								HX_STACK_LINE(349)
								int tmp26 = (int(b3) & int((int)63));		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(349)
								::String tmp27 = b64.charAt(tmp26);		HX_STACK_VAR(tmp27,"tmp27");
								HX_STACK_LINE(349)
								charsBuf->add(tmp27);
							}
							HX_STACK_LINE(351)
							...
							if ((tmp9)){
								...
								HX_STACK_LINE(352)
								{
									...
									HX_STACK_LINE(352)
									tmp10 = v1->b->__get(pos);
								}
								HX_STACK_LINE(352)
								int b1 = tmp10;		HX_STACK_VAR(b1,"b1");
								HX_STACK_LINE(353)
								int tmp11;		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(353)
								{
								...
								HX_STACK_LINE(353)
								int b2 = tmp11;		HX_STACK_VAR(b2,"b2");
								HX_STACK_LINE(354)
								int tmp12 = (int(b1) >> int((int)2));		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(354)
								::String tmp13 = b64.charAt(tmp12);		HX_STACK_VAR(tmp13,"tmp13");
								HX_STACK_LINE(354)
								charsBuf->add(tmp13);
								HX_STACK_LINE(355)
								int tmp14 = (int(b1) << int((int)4));		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(355)
								int tmp15 = (int(b2) >> int((int)4));		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(355)
								int tmp16 = (int(tmp14) | int(tmp15));		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(355)
								int tmp17 = (int(tmp16) & int((int)63));		HX_STACK_VAR(tmp17,"tmp17");
								HX_STACK_LINE(355)
								::String tmp18 = b64.charAt(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(355)
								charsBuf->add(tmp18);
								HX_STACK_LINE(356)
								int tmp19 = (int(b2) << int((int)2));		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(356)
								...
								HX_STACK_LINE(357)
								int tmp11 = (max + (int)1);		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(357)
								...
								if ((tmp12)){
									...
									HX_STACK_LINE(358)
									int b1 = tmp13;		HX_STACK_VAR(b1,"b1");
									HX_STACK_LINE(359)
									int tmp14 = (int(b1) >> int((int)2));		HX_STACK_VAR(tmp14,"tmp14");
									HX_STACK_LINE(359)
									::String tmp15 = b64.charAt(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
							...
							HX_STACK_LINE(362)
							::String tmp10 = charsBuf->b->join(HX_HCSTRING("","\x00","\x00","\x00","\x00"));		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(362)
							::String chars = tmp10;		HX_STACK_VAR(chars,"chars");
							HX_STACK_LINE(364)
							::StringBuf tmp11 = this->buf;		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(364)
							tmp11->add(HX_HCSTRING("s","\x73","\x00","\x00","\x00"));
							HX_STACK_LINE(365)
							::StringBuf tmp12 = this->buf;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(365)
							int tmp13 = chars.length;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(365)
							tmp12->add(tmp13);
							HX_STACK_LINE(366)
							::StringBuf tmp14 = this->buf;		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(366)
							tmp14->add(HX_HCSTRING(":","\x3a","\x00","\x00","\x00"));
							HX_STACK_LINE(367)
							::StringBuf tmp15 = this->buf;		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(367)
							::String tmp16 = chars;		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(367)
							tmp15->add(tmp16);
						}
						else  {
							...
							if ((tmp7)){
								HX_STACK_LINE(369)
								cpp::ArrayBase tmp8 = this->cache;		HX_STACK_VAR(tmp8,"tmp8");
								HX_STACK_LINE(369)
								tmp8->__Field(HX_HCSTRING("pop","\x91","\x5d","\x55","\x00"), hx::paccDynamic )();
							}
							HX_STACK_LINE(370)
							...
							if ((tmp8)){
								...
								if ((tmp12)){
									HX_STACK_LINE(373)
									cpp::ArrayBase tmp13 = this->cache;		HX_STACK_VAR(tmp13,"tmp13");
									HX_STACK_LINE(373)
									Dynamic tmp14 = v;		HX_STACK_VAR(tmp14,"tmp14");
									HX_STACK_LINE(373)
									tmp13->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp14);
								}
								HX_STACK_LINE(374)
				...
				case (int)7: {
					...
					HX_STACK_LINE(406)
					{
						...
						if ((tmp3)){
							...
							HX_STACK_LINE(410)
							tmp6->__Field(HX_HCSTRING("pop","\x91","\x5d","\x55","\x00"), hx::paccDynamic )();
						}
						HX_STACK_LINE(412)
						::StringBuf tmp4 = this->buf;		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(412)
						...
						if ((tmp13)){
							HX_STACK_LINE(504)
							cpp::ArrayBase tmp14 = this->cache;		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(504)
							Dynamic tmp15 = v;		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(504)
							tmp14->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp15);
						}
					}
				}
				;break;
...
::String Serializer_obj::run( Dynamic v){
	HX_STACK_FRAME("haxe.Serializer","run",0xcdbeded7,"haxe.Serializer.run","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/Serializer.hx",544,0x83b02f63)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(545)
