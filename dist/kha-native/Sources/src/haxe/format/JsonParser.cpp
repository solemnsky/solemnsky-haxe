...
{
HX_STACK_FRAME("haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/format/JsonParser.hx",49,0x34f0d888)
HX_STACK_THIS(this)
...
Dynamic JsonParser_obj::parseRec( ){
	HX_STACK_FRAME("haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/format/JsonParser.hx",55,0x34f0d888)
	HX_STACK_THIS(this)
	HX_STACK_LINE(55)
	while((true)){
		HX_STACK_LINE(56)
		...
		switch( (int)(tmp1)){
			...
			case (int)123: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/format/JsonParser.hx",61,0x34f0d888)
						{
			...
			case (int)91: {
				HX_STACK_LINE(87)
				cpp::ArrayBase tmp2 = cpp::ArrayBase_obj::__new();		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(87)
				cpp::ArrayBase arr = tmp2;		HX_STACK_VAR(arr,"arr");
				HX_STACK_LINE(87)
				Dynamic comma = null();		HX_STACK_VAR(comma,"comma");
				HX_STACK_LINE(88)
				while((true)){
					...
					switch( (int)(tmp4)){
						...
						case (int)93: {
							...
							HX_STACK_LINE(95)
							cpp::ArrayBase tmp6 = arr;		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(95)
							return tmp6;
						}
						;break;
...
::String JsonParser_obj::parseString( ){
	HX_STACK_FRAME("haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/format/JsonParser.hx",136,0x34f0d888)
	HX_STACK_THIS(this)
	HX_STACK_LINE(137)
...
{
		HX_STACK_FRAME("haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/format/JsonParser.hx",247,0x34f0d888)
		HX_STACK_THIS(this)
		HX_STACK_LINE(248)
		(this->pos)--;
		HX_STACK_LINE(249)
...
{
		HX_STACK_FRAME("haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/tmp/haxe/export/common/kha/Kha/Tools/haxe/std/haxe/format/JsonParser.hx",252,0x34f0d888)
		HX_STACK_THIS(this)
