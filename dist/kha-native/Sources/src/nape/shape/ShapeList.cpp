	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((tmp4)){
					HX_STACK_LINE(666)
					::String tmp6 = HX_HCSTRING("Error: Shape","\xf3","\xcf","\x83","\xf2");		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(666)
		...
		HX_STACK_LINE(671)
		::nape::shape::ShapeList tmp = ret;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(671)
		return tmp;
	}
}
...
bool ShapeList_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ShapeList_obj::__register()
{
	...
	__mClass->mSetStaticField = &ShapeList_obj::__SetStatic;
