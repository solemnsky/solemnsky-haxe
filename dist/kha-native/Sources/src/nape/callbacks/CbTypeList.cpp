	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(664)
				::nape::callbacks::CbType tmp5;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(664)
				if ((tmp4)){
					HX_STACK_LINE(666)
					::String tmp6 = HX_HCSTRING("Error: CbType","\xe7","\xfb","\x23","\x5e");		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(666)
		...
		HX_STACK_LINE(671)
		::nape::callbacks::CbTypeList tmp = ret;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(671)
		return tmp;
	}
}
...
::nape::callbacks::CbTypeList CbTypeList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(311)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::callbacks::CbType tmp3 = array->__get(_g).StaticCast< ::nape::callbacks::CbType >();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(311)
			::nape::callbacks::CbType i = tmp3;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::callbacks::CbType tmp4 = i;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(316)
			ret->push(tmp4);
		}
	}
...
bool CbTypeList_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void CbTypeList_obj::__register()
{
	...
	__mClass->mSetStaticField = &CbTypeList_obj::__SetStatic;
