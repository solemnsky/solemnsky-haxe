	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((tmp4)){
					HX_STACK_LINE(666)
					::String tmp6 = HX_HCSTRING("Error: Arbiter","\x3b","\x05","\xef","\x18");		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(666)
		...
		HX_STACK_LINE(671)
		::nape::dynamics::ArbiterList tmp = ret;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(671)
		return tmp;
	}
}
...
::nape::dynamics::ArbiterList ArbiterList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(311)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::dynamics::Arbiter tmp3 = array->__get(_g).StaticCast< ::nape::dynamics::Arbiter >();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(311)
			::nape::dynamics::Arbiter i = tmp3;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::dynamics::Arbiter tmp4 = i;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(316)
			ret->push(tmp4);
		}
	}
...
bool ArbiterList_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ArbiterList_obj::__register()
{
	...
	__mClass->mSetStaticField = &ArbiterList_obj::__SetStatic;
