	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(664)
				::nape::geom::RayResult tmp5;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(664)
				if ((tmp4)){
					HX_STACK_LINE(666)
					::String tmp6 = HX_HCSTRING("Error: RayResult","\x39","\xbc","\xce","\x9c");		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(666)
		...
		HX_STACK_LINE(671)
		::nape::geom::RayResultList tmp = ret;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(671)
		return tmp;
	}
}
...
::nape::geom::RayResultList RayResultList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(311)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::geom::RayResult tmp3 = array->__get(_g).StaticCast< ::nape::geom::RayResult >();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(311)
			::nape::geom::RayResult i = tmp3;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::geom::RayResult tmp4 = i;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(316)
			ret->push(tmp4);
		}
	}
...
bool RayResultList_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void RayResultList_obj::__register()
{
	...
	__mClass->mSetStaticField = &RayResultList_obj::__SetStatic;
