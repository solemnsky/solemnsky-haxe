	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(664)
				::nape::geom::GeomPoly tmp5;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(664)
				if ((tmp4)){
					HX_STACK_LINE(666)
					::String tmp6 = HX_HCSTRING("Error: GeomPoly","\x96","\x19","\x47","\x5b");		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(666)
		...
		HX_STACK_LINE(671)
		::nape::geom::GeomPolyList tmp = ret;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(671)
		return tmp;
	}
}
...
bool GeomPolyList_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GeomPolyList_obj::__register()
{
	...
	__mClass->mSetStaticField = &GeomPolyList_obj::__SetStatic;
