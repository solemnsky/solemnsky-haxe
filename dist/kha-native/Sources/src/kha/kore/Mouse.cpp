...
{
HX_STACK_FRAME("kha.kore.Mouse","new",0xec9b6daa,"kha.kore.Mouse.new","kha/kore/Mouse.hx",5,0xfa8e3166)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(5)
	super::__construct();
...
void Mouse_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("kha.kore.Mouse","\xb8","\x10","\x5d","\x80");
